...
//    private ImageView imageViewUser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collectionReference = firebaseFirestore.collection("Users").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        UserFirebase userFirebase = new UserFirebase(document.getId(), document.getId(), (Double) document.get("score"));
